...
public class JdbcBookRepository implements BookRepository {
	...
	// TODO 1: Annotate method to be called by container during bean initialization
	public void initialize(){
		logger.info("initialize() <-");
	}
	
	// TODO 1: Annotate method to be called by container during bean destruction
	public void cleanup(){
		logger.info("cleanup() <-");
	}
	
	// TODO 2: Annotate method to instruct container to use RequiredAnnotationBean PostProcessor
	//         to check not null dependency
