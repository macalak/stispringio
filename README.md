...
4. Take the Tomcat AS distribution with integrated Derby database from this repository [server/apache-tomcat-8.0.27.zip](https://github.com/macalak/stispringio/blob/master/server/apache-tomcat-8.0.27.zip). Unzip it into *server/runtime* folder.
